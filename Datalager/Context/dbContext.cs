...
namespace Datalager.Context
{
    public class dbContext : DbContext
    {
        ...
        public void Reset()
        {
            ...
            using (SqlConnection conn = new SqlConnection(@"Server=(localdb)\mssqllocaldb;Database=Systemutvecklingsprojekt;Integrated Security=True;MultipleActiveResultSets=true;"))
